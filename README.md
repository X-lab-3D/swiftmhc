<img src="https://github.com/x-lab-3D/swiftmhc/blob/main/logo.png?raw=true" alt="logo is missing" width="70" height="50" /> # SwiftMHC: A High-Speed Attention Network for MHC-Bound Peptide Identification and 3D Modeling
