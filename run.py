...
class Trainer:
    ...
    @staticmethod
    def _get_data_batch(datasets: List[ProteinLoopDataset], names: List[str]) -> Dict[str, torch.Tensor]:
    ...
    def train(self,
        ...
        if animated_complex_ids is not None:
            ...
            animated_data = self._get_data_batch(datasets, animated_complex_ids)
