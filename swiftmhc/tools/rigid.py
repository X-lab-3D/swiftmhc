...
import torch
from .quat import conjugate_quat
from .quat import multiply_quat
from .quat import rotate_vec_by_quat
...
class Rigid(openfold.utils.rigid_utils.Rigid):
    ...
    def compose_q_update_vec(self, q_update_vec: torch.Tensor) -> Rigid:
        ...
        return Rigid(
            openfold.utils.rigid_utils.Rotation(quats=new_q, normalize_quats=False), new_translation
        )
