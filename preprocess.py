...
arg_parser.add_argument("table_path", help="table with input data, containing: ID, allele (optional), measurement_value (optional), measurement_inequality (optional)")
